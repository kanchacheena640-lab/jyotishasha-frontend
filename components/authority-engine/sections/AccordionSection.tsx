...
export default function AccordionSection({ section, locale }: SectionRendererProps) {
        ...
        {section.items.map(item => {
          ...
          return (
            <div key={item.id} className="rounded-xl border border-white/10 bg-white/[0.03] overflow-hidden">
              ...
              {isOpen && item.body && (
                <div className="px-4 pb-4 pt-3 text-xs text-gray-400 leading-relaxed border-t border-white/10">
