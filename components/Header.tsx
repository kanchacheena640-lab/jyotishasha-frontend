...
export default function Header() {
  ...
  const navLinks = [
    ...
    { href: currentLang === 'hi' ? '/hi/panchang' : '/panchang', label: { en: 'Panchang', hi: 'पंचांग' } },
    { href: currentLang === 'hi' ? '/hi/ekadashi' : '/ekadashi', label: { en: 'Ekadashi', hi: 'एकादशी' } },
    { href: currentLang === 'hi' ? '/hi/navratri' : '/navratri', label: { en: 'Navratri', hi: 'नवरात्रि' } },
    { href: currentLang === 'hi' ? '/hi/rahu-kaal' : '/rahu-kaal', label: { en: 'Rahu Kaal', hi: 'राहु काल' } },
