// lib/domains/_templates/stable-career.ts
// TEMPLATE — copy to [your-domain]/topics/ and replace all TODO: placeholders.
// Topic pattern: career stability / longevity / job security / income consistency topics.
//
...
export const stableCareer: DomainTopic = {

  identity: {
    id:         'financial-astrology:stable-career',  // TODO: replace with your '[subdomain]:[slug]'
    slug:       'stable-career',
  ...
  routing: {
    canonicalPath: '/financial-astrology/stable-career',  // TODO: /[subdomain]/[slug]
    breadcrumbs: [
      { label: 'Home',                label_hi: 'होम',             href: '/' },
      { label: 'Financial Astrology', label_hi: 'वित्तीय ज्योतिष', href: '/financial-astrology' },
      { label: 'Stable Career',       label_hi: '',                href: '/financial-astrology/stable-career' },
    ],
  },
