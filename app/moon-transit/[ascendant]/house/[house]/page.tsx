...
export async function generateMetadata({
  ...
  return {
    title: `Moon Transit in ${houseNum} House for ${asc} Ascendant – Mood & Intuition`,
    description: `Expert Vedic analysis of Moon (Chandra) transit in House ${houseNum} for ${asc} rising. Understand daily emotional shifts, mental clarity, and intuitive growth.`,
    alternates: {
...
export default async function MoonTransitHousePage({
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        "name": `How does the Moon transit in ${houseNum} house affect ${ascTitle} rising?`,
        "acceptedAnswer": {
          "@type": "Answer",
          "text": `For ${ascTitle} ascendant, the Moon in the ${houseNum} house activates specific emotional responses, subconscious patterns, and mental focus in the life areas governed by this house.`
        }
      }
    ]
  };
    ...
    <div className="bg-gradient-to-b from-slate-900 to-indigo-950/20 py-12 md:py-20 px-4">
      ...
      <article className="max-w-5xl mx-auto bg-white rounded-[2.5rem] px-6 md:px-16 py-16 shadow-2xl text-slate-900 relative border border-slate-100">
        ...
        <nav className="flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 mb-10 border-b border-slate-50 pb-6">
          <Link href="/moon-transit" className="hover:text-indigo-600 transition">Moon Hub</Link>
          <span className="text-slate-200">/</span>
          <Link href={`/moon-transit/${params.ascendant}`} className="hover:text-indigo-600 transition">{ascTitle}</Link>
          <span className="text-slate-200">/</span>
        ...
        <div className="my-16 flex flex-col md:flex-row items-center gap-12 bg-indigo-50/50 p-8 rounded-[2rem] border border-indigo-100 shadow-inner">
           ...
           <div className="space-y-4">
              <h2 className="text-xl font-black text-slate-800 uppercase tracking-tight">Emotional Activation</h2>
              <p className="text-slate-600 leading-relaxed font-medium text-lg">
                In Vedic astrology, the <strong>Moon (Chandra)</strong> is the Mother and the Mind. Its transit in your {houseNum} house dictates your <strong>emotional frequency, instincts, and mental peace</strong> for this cycle.
              </p>
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-100 text-indigo-700 rounded-full text-xs font-black uppercase tracking-widest">
                 Status: Intuitive Alignment Phase
              </div>
           </div>
        </div>
                ...
                {sec.points.map((p: string, j: number) => (
                  <li key={j} className="flex gap-4 text-slate-700 text-lg leading-relaxed">
                    <span className="text-indigo-500 mt-1.5 shrink-0">
                      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2a10 10 0 1 0 10 10H12V2z"></path><path d="M12 2a10 10 0 0 1 10 10"></path></svg>
                    </span>
                    {p}
                  </li>
                ))}
        ...
        {/* Peace vs Restlessness - Emotional Contrast */}
        <div className="grid md:grid-cols-2 gap-8 mt-16 pb-20 border-b border-slate-100">
          <div className="bg-emerald-50/40 border border-emerald-100 rounded-[2.5rem] p-10">
            ...
            <h4 className="text-xl font-black mb-4 text-emerald-900 uppercase tracking-widest text-sm">Inner Peace</h4>
          ...
          <div className="bg-rose-50/40 border border-rose-100 rounded-[2.5rem] p-10">
            ...
            <h4 className="text-xl font-black mb-4 text-rose-900 uppercase tracking-widest text-sm">Mind Waves</h4>
            <ul className="space-y-4">
        ...
        <div className="mt-20 bg-slate-950 rounded-[3.5rem] p-8 md:p-16 text-white text-center shadow-3xl relative overflow-hidden">
          ...
          <p className="text-slate-400 mb-10 max-w-2xl mx-auto text-lg md:text-xl font-medium relative z-10">
            General Moon transits define the "vibe," but your <strong>Natal Moon (Janma Rashi)</strong> and <strong>Nakshatra</strong> define your reality. Align your schedule with your personal lunar clock.
          </p>
