  ...
  return (
    <div className="bg-gradient-to-b from-red-900 to-red-800 py-16">
      <article className="max-w-5xl mx-auto bg-white rounded-2xl px-6 md:px-10 py-14 shadow-xl text-black">
        ...
        {/* CTA – Personalized Mars Transit */}
        <div className="mt-10 bg-gradient-to-r from-red-600 to-orange-600 rounded-2xl p-7 text-white shadow-lg">

          <h3 className="text-2xl font-bold mb-3">
            This Is a General Mars Transit — Want Your Real Action Timeline?
          </h3>

          <p className="text-white/95 leading-relaxed mb-5">
            This page explains the <strong>Mars transit in House {houseNum}</strong> for a
            <strong> {ascTitle} Ascendant</strong>.
          </p>

          <ul className="list-disc pl-6 space-y-1 text-white/95 mb-6">
            <li>Actual Mars strength & degree</li>
            <li>Mangal Dosh or cancellation</li>
            <li>Aspects from Saturn, Rahu & Jupiter</li>
            <li>Running Mahadasha & Antardasha</li>
            <li>Conflict, energy & health triggers</li>
          </ul>
