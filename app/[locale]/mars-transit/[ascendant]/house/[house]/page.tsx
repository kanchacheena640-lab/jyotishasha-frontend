...
import { marsConfig } from "@/lib/transit/planetConfig";
...
export async function generateMetadata({
  ...
  return getTransitMetadata({
    planetEn: marsConfig.planetEn,
    planetHi: marsConfig.planetHi,
    slug: `${marsConfig.slug}/${params.ascendant}/house-${houseNum}`,
...
export default async function MarsTransitHousePage(props: {
  params: { ascendant: string; house: string; locale: string };
  searchParams?: { lang?: string };
}) {
  return HouseTransitPage({ ...props, config: marsConfig });
}
