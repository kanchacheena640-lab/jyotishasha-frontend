...
import { rahuConfig } from "@/lib/transit/planetConfig";
...
export async function generateMetadata({
  ...
  return getTransitMetadata({
    planetEn: rahuConfig.planetEn,
    planetHi: rahuConfig.planetHi,
    slug: `${rahuConfig.slug}/${params.ascendant}/house-${houseNum}`,
...
export default async function RahuTransitHousePage(props: {
  params: { ascendant: string; house: string; locale: string };
  searchParams?: { lang?: string };
}) {
  return HouseTransitPage({ ...props, config: rahuConfig });
}
