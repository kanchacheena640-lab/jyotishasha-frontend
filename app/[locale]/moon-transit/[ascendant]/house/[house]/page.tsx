...
import { moonConfig } from "@/lib/transit/planetConfig";
...
export async function generateMetadata({
  ...
  return getTransitMetadata({
    planetEn: moonConfig.planetEn,
    planetHi: moonConfig.planetHi,
    slug: `${moonConfig.slug}/${params.ascendant}/house-${houseNum}`,
...
export default async function MoonTransitHousePage(props: {
  params: { ascendant: string; house: string; locale: string };
  searchParams?: { lang?: string };
}) {
  return HouseTransitPage({ ...props, config: moonConfig });
}
