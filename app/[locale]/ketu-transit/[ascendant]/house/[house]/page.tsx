...
import { ketuConfig } from "@/lib/transit/planetConfig";
...
export async function generateMetadata({
  ...
  return getTransitMetadata({
    planetEn: ketuConfig.planetEn,
    planetHi: ketuConfig.planetHi,
    slug: `${ketuConfig.slug}/${params.ascendant}/house-${houseNum}`,
...
export default async function KetuTransitHousePage(props: {
  params: { ascendant: string; house: string; locale: string };
  searchParams?: { lang?: string };
}) {
  return HouseTransitPage({ ...props, config: ketuConfig });
}
