...
import { venusConfig } from "@/lib/transit/planetConfig";
...
export async function generateMetadata({
  ...
  return getTransitMetadata({
    planetEn: venusConfig.planetEn,
    planetHi: venusConfig.planetHi,
    slug: `${venusConfig.slug}/${params.ascendant}/house-${houseNum}`,
...
export default async function VenusTransitHousePage(props: {
  params: { ascendant: string; house: string; locale: string };
  searchParams?: { lang?: string };
}) {
  return HouseTransitPage({ ...props, config: venusConfig });
}
