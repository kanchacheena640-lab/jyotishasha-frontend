...
import { jupiterConfig } from "@/lib/transit/planetConfig";
...
export async function generateMetadata({
  ...
  return getTransitMetadata({
    planetEn: jupiterConfig.planetEn,
    planetHi: jupiterConfig.planetHi,
    slug: `${jupiterConfig.slug}/${params.ascendant}/house-${houseNum}`,
...
export default async function JupiterTransitHousePage(props: {
  params: { ascendant: string; house: string; locale: string };
  searchParams?: { lang?: string };
}) {
  return HouseTransitPage({ ...props, config: jupiterConfig });
}
